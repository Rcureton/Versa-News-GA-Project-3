...
public class MusicFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        musicRecycler = (RecyclerView) view.findViewById(R.id.fashion_recycle_list);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        musicRecycler.setLayoutManager(linearLayoutManager);
        musicRecycler.addItemDecoration(new VerticalSpaceItemDecoration(30));
    ...
    private class LoadNewsList extends AsyncTask<Void,Void,List<ViceItemsClass>> {
        ...
        protected List<ViceItemsClass> doInBackground(Void... params) {
            String data = "";
            try {
                URL url = new URL("http://vice.com/api/getlatest/category/music");
