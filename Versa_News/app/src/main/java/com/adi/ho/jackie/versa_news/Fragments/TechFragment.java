...
public class TechFragment extends Fragment {
    ...
    List<ViceItemsClass> techList;
    RecyclerView techRecycler;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        techRecycler = (RecyclerView) view.findViewById(R.id.fashion_recycle_list);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        techRecycler.setLayoutManager(linearLayoutManager);
        techRecycler.addItemDecoration(new VerticalSpaceItemDecoration(30));
    ...
    private class LoadNewsList extends AsyncTask<Void,Void,List<ViceItemsClass>> {
        ...
        protected List<ViceItemsClass> doInBackground(Void... params) {
            String data = "";
            try {
                URL url = new URL("http://vice.com/api/getlatest/category/tech");
