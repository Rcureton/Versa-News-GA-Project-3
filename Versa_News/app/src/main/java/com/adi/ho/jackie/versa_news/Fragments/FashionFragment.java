...
public class FashionFragment extends Fragment {
    ...
    List<ViceItemsClass> fashionList;
    RecyclerView fashionRecycler;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fashionRecycler = (RecyclerView) view.findViewById(R.id.fashion_recycle_list);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        fashionRecycler.setLayoutManager(linearLayoutManager);
        fashionRecycler.addItemDecoration(new VerticalSpaceItemDecoration(30));
    ...
    private class LoadNewsList extends AsyncTask<Void,Void,List<ViceItemsClass>> {
        ...
        protected List<ViceItemsClass> doInBackground(Void... params) {
            String data = "";
            try {
                URL url = new URL("http://vice.com/api/getlatest/category/fashion");
        ...
        protected void onPostExecute(List<ViceItemsClass> viceItemsClasses) {
            ...
            fashionRecycler.setAdapter(adapter);
